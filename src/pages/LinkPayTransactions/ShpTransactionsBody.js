import styles from './ShpTransactionsBody.module.scss'
import ShpTransactionsList from './ShpTransactionsList'
...
export default function ShpTransactionsBody() {
  ...
  return (
    <div className={styles.body}>
      <div className={styles.header}>
        <h1>Транзакции LinkPay</h1>
      </div>
      <ShpTransactionsList transactions={transactions} isLoading={isLoading} setTransactions={setTransactions} />
